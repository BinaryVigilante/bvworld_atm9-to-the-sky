...
Last README file update: Wed Jun 05 23:47:40 CEST 2024
...
command.walkers.playerBlacklist
command.walkers.playerBlacklist.add
command.walkers.playerBlacklist.add.playerUUID
command.walkers.playerBlacklist.add.players
command.walkers.playerBlacklist.isWhitelist
command.walkers.playerBlacklist.isWhitelist.value
command.walkers.playerBlacklist.list
command.walkers.playerBlacklist.remove
command.walkers.playerBlacklist.remove.players
command.walkers.playerBlacklist.remove.players.playerUUID
...
command.walkers.switchShape.player.normal
